  ...
  request({ url, json: true}, (err, {body}) => {
    if(err) {
      ...
      callback(undefined, {
        ...
        day1max: body.daily.data[0].temperatureHigh,
        day1min: body.daily.data[0].temperatureLow,
        day2sum: body.daily.data[1].summary,
        day2max: body.daily.data[1].temperatureHigh,
        day2min: body.daily.data[1].temperatureLow,
        day3sum: body.daily.data[2].summary,
        day3max: body.daily.data[2].temperatureHigh,
        day3min: body.daily.data[2].temperatureLow,
        day4sum: body.daily.data[3].summary,
        day4max: body.daily.data[3].temperatureHigh,
        day4min: body.daily.data[3].temperatureLow,
        day5sum: body.daily.data[4].summary,
        day5max: body.daily.data[4].temperatureHigh,
        day5min: body.daily.data[4].temperatureLow,
        day6sum: body.daily.data[5].summary,
        day6max: body.daily.data[5].temperatureHigh,
        day6min: body.daily.data[5].temperatureLow,
      });
    }
  });
}
